...
const INTERNAL_ROUTES = ['/vacancy', '/move-in', '/move-out', '/docs', '/marketing', '/flyer'];
...
export const config = {
  matcher: ['/vacancy/:path*', '/move-in/:path*', '/move-out/:path*', '/docs/:path*', '/marketing/:path*', '/flyer/:path*'],
};
