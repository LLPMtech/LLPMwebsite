      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-navy rounded-lg p-6 text-white">
            <h2 className="text-xl font-bold mb-2">📄 One-Page Flyer</h2>
            <p className="text-gray-300 text-sm mb-4">Quick single-page flyer with photo, key stats, and property details. Best for email and LoopNet.</p>
            <a href="/flyer" className="block text-center bg-gold text-navy px-6 py-2 rounded-lg font-bold hover:bg-opacity-90 transition">
              Generate One-Pager →
            </a>
          </div>
          <div className="bg-rust-orange rounded-lg p-6 text-white">
            <h2 className="text-xl font-bold mb-2">📋 5-Page Package</h2>
            <p className="text-orange-100 text-sm mb-4">Full listing package with cover, overview, site details, location & access, and back cover.</p>
            <a href="/flyer5" className="block text-center bg-gold text-navy px-6 py-2 rounded-lg font-bold hover:bg-opacity-90 transition">
              Generate 5-Pager →
            </a>
          </div>
        </div>
